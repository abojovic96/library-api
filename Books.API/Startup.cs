...
using Books.Database.Repository;
...
namespace Books.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(typeof(Models.Profiles.BookProfile));
            services.AddAutoMapper(typeof(Models.Profiles.AuthorProfile));
            services.AddAutoMapper(typeof(Models.Profiles.GenreProfile));
            services.AddAutoMapper(typeof(Logic.Models.Profiles.BookProfile));
            services.AddAutoMapper(typeof(Logic.Models.Profiles.AuthorProfile));
            services.AddAutoMapper(typeof(Logic.Models.Profiles.GenreProfile));
            ...
            {
                jwtConfig.Key = Configuration["Jwt:Key"];
                jwtConfig.Audience = Configuration["Jwt:Audience"];
                jwtConfig.Issuer = Configuration["Jwt:Issuer"];
            });
        }
